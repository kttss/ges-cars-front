...
export class AdminLayoutComponent implements OnInit {
  ...
  private lastPoppedUrl: any | string = '';
  private yScrollStack: number[] = [];
  image: any = null;

  @ViewChild('btn', { static: true }) btnn: any = null;
  ...
  ngOnInit() {
    this.fileService.showImage.subscribe((img) => {
      this.image = img;
      this.btnn.nativeElement.click();
    });
